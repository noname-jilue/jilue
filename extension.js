  ...
  return {
    ...
    content: function (config) {
      ...
      let trivialSolveCharacterReplace = function (name) {
        var shortname = i.substring(i.lastIndexOf('_') + 1);
        if (shortname && lib.character[shortname]) {
          if (!lib.characterReplace[shortname]) {
            // console.log(shortname);
            lib.characterReplace[shortname] = [shortname, i];
          } else {
            lib.characterReplace[shortname].push(i);
          }
        }
      };
        ...
        game.import('character', function () {
          var jlsg_sc = {
            ...
            skill: {
              ...
              jlsg_cexin: {
                ...
                content: function () {
                  ...
                  if (goon) {
                    player.chooseTarget('测心：是否额外指定一名' + get.translation(trigger.card) + '的目标？', function (card, player, target) {
                  ...
                  if (result.bool) {
                    ...
                    event.target = result.targets[0];
                    player.chooseCardButton('选择弃置一张［卷］', true, player.storage.jlsg_lanjuan).ai = function (button) {
                      return true;
                    };
                  } else {
                    event.finish();
                  ...
                  event.finish();
                  'step 3'
                  player.chooseTarget('测心：是否减少一名' + get.translation(trigger.card) + '的目标？', function (card, player, target) {
              ...
              jlsg_re_jiyu: {
                ...
                content: function () {
                  'step 0'
                  player.chooseTarget(get.prompt('jlsg_re_jiyu'), "移去1枚［计］，然后令一名其他角色获得1枚［计］", function (card, player, target) {
              ...
              jlsg_longying: {
                ...
                content: function () {
                  ...
                  var next = player.chooseToDiscard(1, 'he', '龙吟：是否弃置一张牌？<br><li>若弃置的牌为<span style="color:#FF0000">红色</span>则' + translation + '的' + translation2 + '不计入出杀次数。<br><li>若弃置的牌为<span style="color:#FF00FF">黑色</span>则' + translation + '的' + translation2 + '可以额外指定1个目标。', function (card, player) {
                    return true;
                  });
            ...
            translate: {
              ...
              jlsgsc_guanping: "关平",
              jlsg_longying: "龙吟",
              jlsg_longying_info: "每当一名角色在其出牌阶段使用【杀】时，你可弃置一张牌来触发以下效果：1.若弃置的牌为红色，不计入出牌阶段使用次数，然后你摸一张牌；2.若弃置的牌为黑色，可以额外指定1个目标。",
              ...
              jlsgsc_re_zhouyu: "周瑜",
              jlsg_new_yingzi: "英姿",
              jlsg_new_yingzi_info: "锁定技，你的回合内，使用一张牌并摸一张牌。",
              jlsgsc_recaoying: "曹婴",
              jlsg_re_xieji: "蝎计·判定",
              jlsg_re_xieji1: "蝎计",
              jlsg_re_xieji2: "蝎计·屯牌",
              jlsg_re_xieji1_info: "摸牌阶段开始时，若你没有［计］时，你可以多摸一张牌；若如此做，出牌阶段结束时，你可以将至少一张手牌，置入你的武将牌，称为［计］最多4枚；下回合出牌阶段开始时，你可以进行判定，然后可以将1枚与判定牌相同花色的［计］弃置并摸2张牌，然后你继续判定，直到你无法弃置与判定牌相同花色的［计］为止。",
              jlsg_re_xieji_info: "你可以进行判定，然后可以将1枚与判定牌相同花色的［计］弃置并摸2张牌，然后你继续判定，直到你无法弃置与判定牌相同花色的［计］为止。",
              jlsg_re_jiyu: "计育",
              jlsg_re_jiyu2: "计育·免伤",
              jlsg_re_jiyu_info: "你的回合结束时，若你有标记时，你可以将1枚［计］移至一名其他角色，该角色出牌阶段可执行［蝎计］的判定；计：当你受到1次伤害时，若没有手牌时，可以弃置1枚［计］来抵消此伤害。",
              jlsgsc_erluxun: "新界陆逊",
              jlsg_ershenbing: "神兵",
              jlsg_ershenbing_info: "变化技，当你受到1点伤害后，你可以随机获得一张未加入游戏的吴国武将牌置入你的武将牌上（觉醒技、主公技、限定技和变化技除外），称为［营］最多2枚；你拥有［营］的所有技能。",
              jlsg_erqiying: "弃营",
              ...
              jlsg_longdan3: "龙胆·桃",
              jlsg_longdan4: "龙胆·酒",
              jlsg_longdan_info: "你可以将一张手牌当做【杀】、【闪】、【桃】、【酒】使用或打出。",
              jlsg_lanjuan: "览卷",
              jlsg_shibie: "士别",
              jlsg_cexin: "测心",
              jlsgsc_relvmeng: "新界吕蒙",
              jlsg_lanjuan_info: "若你的武将牌顶的标记不大于4时，你可以放弃摸牌，改为从牌堆顶亮出5张牌，然后选择获得不同花色的牌各一张；其余的牌置入你的武将牌顶，称为［卷］最多4枚。锁定技，若你的身份为“主公”时，你不增加体力上限。",
              ...
              jlsg_zonghuo: "纵火",
              jlsg_shaoying: "烧营",
              jlsg_zonghuo_info: '你可以弃置一张牌将你即将造成的伤害转为火焰伤害。',
              jlsg_shaoying_info: '当你造成1次火焰伤害后，可指定距离受到伤害的该角色1以内的另一名角色，并展示牌堆顶的一张牌，若此牌为红色，该角色受到（之前受到你的火焰伤害的角色）1点火焰伤害。',
              jlsgsc_lvmeng: "吕蒙",
              jlsg_keji: "克己",
              ...
              jlsg_qinran_info: "出牌阶段限1次，你可以指定一名其他角色，令其于其下回合开始时失去1点体力。",
            },
          };
          ...
          var jlsg_sk = {
            ...
            skill: {
              ...
              jlsg_zhoufu: {
                ...
                content: function () {
                  'step 0'
                  player.chooseToDiscard('h', '咒缚', '弃置一张手牌，令其进行判定', true).ai = function (card) {
                    return 6 - get.value(card);
                  };
                  'step 1'
                  if (result.bool) {
              ...
              jlsg_jiwux: {
                ...
                content: function () {
                  ...
                  if (result.bool) {
                    ...
                    var prompt = '戟舞<br><br><div class="text">1:此【杀】不计入次数限制</div><br><div class="text">'
                    '2:此【杀】无距离限制,且可以额外指定1个目标</div></br><div class="text">3:此【杀】的伤害值+1。</br>';
                    player.chooseControl(['选项一', '选项二', '选项三'], function () {
                      if (Math.random() < 1 / 3) return '选项一';
                      return Math.random() < 0.5 ? '选项二' : '选项三';
                    }).set('prompt', prompt);
                  } else {
                    event.finish();
                  }
              ...
              jlsg_renxin: {
                ...
                check: function (event, player) {
                  if (player.isTurnedOver()) {
                    ...
                    if (player.countCards('h', 'du') > 2 && !jlsg.isFriend(player, event.player)) return true;
                  }
                  return false;
                },
                content: function () {
            ...
            translate: {
              ...
              jlsg_zhoufu_info: '其他角色的回合开始时，你可以弃置一张手牌，令其判定，若结果为黑桃，其于本回合内失去其所有技能；若结果为梅花，其弃置两张牌。',
              ...
              jlsg_fushe_info: '其他角色的出牌阶段开始时，若其在你的攻击范围内，你可以选择一种花色。若如此做，此阶段结束时，若其有此花色的牌进入弃牌堆，你对其造成1点伤害，然后摸一张牌。',
              ...
              jlsg_lirang_info: '一名角色的回合开始阶段结束时，其可以将一张与所有［礼］花色均不同的手牌置于你的武将牌上，成为［礼］，然后摸一张牌。你可以将2张［礼］当【桃】使用。',
              ...
              jlsg_guhuo_info: '（没有〈缠怨〉技能）其他角色的回合开始时，你可以与其拼点：若你赢，可以视为使用一张非延迟锦囊牌；若你没赢，该角色对你造成1点伤害。',
              ...
              jlsg_duanlan: "断缆",
              jlsg_duanlan_info: "出牌阶段限1次，你可以弃置其他角色区域内的1至3张牌，然后选择1项： 1、失去1点体力;2、弃置一张大于这些牌点数之和的牌。",
              jlsg_yaoming: "邀名",
              jlsg_yaoming1: "邀名",
              jlsg_yaoming2: "邀名",
              jlsg_yaoming3: "邀名",
        ...
        game.import('character', function () {
          var jlsg_sr = {
            ...
            character: {
              ...
              jlsgsr_zhenji: ['female', 'wei', 3, ['jlsg_liuyun', 'jlsg_lingbo', 'jlsg_qingcheng'], ['die_audio']],
              ...
              jlsgsr_luxun: ['male', 'wu', 2, ['jlsg_dailao', 'jlsg_youdi', 'jlsg_ruya'], ['die_audio']],
            ...
            skill: {
              ...
              //     return 8 - get.value(card)
              //   },
              //   prompt: '弃置一张黑色牌，令一名角色选择1项：恢复1点体力或摸2张牌',
              //   filterTarget: true,
              //   content: function () {
              //     player.link();
              ...
              jlsg_sheji: {
                ...
                content: function () {
                  ...
                  next.ai = function (card) {
                    if (jlsg.isKongcheng(player) && jlsg.needKongcheng(player, true)) return false;
              ...
              jlsg_tuwei: {
                ...
                filter: function (event, player) {
                  ...
                  var criterion0 = event.cards.filter(card => card.name == 'sha' && get.position(card, true) == 'd')
                    .length != 0;
            ...
            translate: {
              ...
              jlsg_aozhan_info: '每当你因杀或决斗造成或受到1点伤害后，你可将牌堆顶的一张牌置于你的武将牌上，称为［战］。出牌阶段限1次，你可以选择1项：1、将所有［战］收入手牌。2、将所有［战］弃置，然后摸等量的牌。',
              ...
              jlsg_guicai_info: '在任意角色的判定牌生效前，你可以选择1项：1、打出一张手牌代替之。2、亮出牌堆顶的一张牌代替之。',
              jlsg_langgu_info: '每当你造成或受到1次伤害后，你可以进行1次判定，若为黑色，你获得对方一张牌。',
              jlsg_zhuizun_info: '限定技，当你进入濒死状态时，你可以恢复体力至1点，令所有其他角色依次交给你一张手牌。然后当前回合结束后，你进行1个额外的回合。',
              jlsg_tianshang_info: '限定技，你死亡时，可令一名其他角色获得你当前另外1项技能，增加1点体力上限并恢复1点体力。',
              ...
              jlsg_huiqu_info: '回合开始阶段，你可以弃置一张手牌进行1次判定，若结果为红色，你将场上的一张牌移动到1个合理的位置；若结果为黑色，你对一名角色造成1点伤害，然后你摸一张牌。',
              jlsg_zhaoxiang_info: '当一名其他角色使用【杀】指定目标后，若其在你攻击范围内，你令其选择1项：1、获得你的一张牌。2、令此【杀】无效；若该角色不在你攻击范围内，你可以弃置一张牌令其做上述选择。',
              jlsg_zhishi_info: '出牌阶段限一次，你可以令一名其他角色选择一项：1、弃置一张基本牌，然后回复一点。2、受到你造成的一点伤害，然后回复一点体力。',
              jlsg_old_zhishi_info: '出牌阶段限1次，你可以指定一名有手牌的其他角色，你选择其中1项执行：1.你展示一张【杀】令其弃置一张【杀】，若其执行，你与其恢复1点体力，否则你对其造成1点伤害；2.你展示一张【闪】令其弃置一张【闪】，若其执行，你与其恢复1点体力，否则你对其造成1点伤害。',
              ...
              jlsg_paoxiao_info: '出牌阶段，当你使用【杀】对目标角色造成1次伤害并结算完毕后，你可以摸一张牌，然后选择1项：使用一张无视距离的【杀】，或令该角色弃置你的一张牌。',
              jlsg_benxi_info: '锁定技，你计算与其他角色的距离时始终-1.你使用【杀】指定目标后，目标角色须弃置一张装备牌，否则此【杀】不可被【闪】响应。',
              jlsg_yaozhan_info: '出牌阶段限1次，你可以与一名其他角色拼点：若你赢，视为对其使用一张【杀】并摸一张牌（此【杀】不计入每回合的使用限制）；若你没赢，该角色可以对你使用一张【杀】。',
              jlsg_wenjiu_info: '出牌阶段限1次，你可以将一张黑色手牌置于你的武将牌上，称为［酒］。当你使用【杀】选择目标后，你可以将一张［酒］置入弃牌堆，然后当此【杀】造成伤害时，该伤害+1；当此【杀】被【闪】响应后，你摸一张牌。',
              jlsg_shuixi_info: '回合开始阶段开始时，你可以展示一张手牌并选择一名其他角色，令其选择1项：弃置一张与之相同花色的手牌，或失去1点体力。若该角色因此法失去体力，则此回合的出牌阶段，你不能使用【杀】。',
              ...
              jlsg_chouxi_info: '出牌阶段限1次，你可以弃置一张手牌并展示牌堆顶的2张牌，然后令一名其他角色选择1项：弃置一张与之均不同类别的牌，然后令你获得这些牌；或受到你造成的1点伤害并获得其中一张牌，然后你获得其余的牌。',
              ...
              jlsg_xiwu_info: '当你使用的【杀】被目标角色的【闪】响应后，你可以摸一张牌，然后弃置其一张手牌。',
              jlsg_juelie_info: '出牌阶段限1次，你可以令一名手牌数与你不同的其他角色选择1项：将手牌数调整至与你相等；或视为你对其使用一张【杀】（不计入出牌阶段的使用限制）。',
        ...
        game.import('character', function () {
          var jlsg_soul = {
            ...
            skill: {
              ...
              jlsg_kuangfeng: {
                ...
                content: function () {
                  ...
                  player.chooseTarget('选择一名角色获得狂风标记').ai = function (target) {
                    if (player.storage.jlsg_xingchen.length > 3) return jlsg.isWeak(target) && jlsg.isEnemy(player, target);
                    return -1;
                  }
                  "step 1"
                  if (result.bool) {
              ...
              jlsg_tianqi: {
                ...
                chooseButton: {
                  ...
                  prompt: function (links, player) {
                    return '亮出牌堆顶的一张牌，并将此牌当' + get.translation(links[0][2]) + '使用。若亮出的牌不为' + get.translation(links[0][0]) + '牌，你须先失去1点体力。(你的出牌阶段限1次。)';
                  }
                },
              ...
              jlsg_tianqi3: {
                ...
                check: function (card, event, player) {
                  ...
                  if (player.hp <= 2 && player.countCards('h', 'sha') && player.storage.jlsg_tianji_top != 'basic') return 0;
                  return 1;
                },
                viewAs: { name: 'sha' },
                viewAsFilter: function (player) {
              ...
              jlsg_tianzi: {
                ...
                content: function () {
                  ...
                  event.current = player.next;
                  "step 1"
                  event.current.chooseToDiscard("he", 2, '弃置2张牌或令其摸一张牌').ai = function (card) {
            ...
            translate: {
              ...
              jlsg_guixin_info: '<li>若在场的游戏玩家〈游戏角色〉大于4时，你受到一次伤害后，你可以随机获得每名其他角色区域里的一张牌，再摸X张牌（X为阵亡的角色数，最多为3人），然后翻面。<li>若在场的游戏玩家〈游戏角色〉不大于5时，你受到一次伤害后，你可以随机获得每名其他角色区域里的一张牌，再摸X张牌（X为你的已损失体力）。',
              ...
              jlsg_huju_info: '锁定技，其他角色的回合开始时，你摸一张牌。你的回合开始时，若你的手牌数为最多（或之一），你选择一项：1、失去一点体力；2、减一点体力上限，失去〈虎踞〉，获得〈制衡〉和〈虎缚〉。',
              ...
              jlsg_shunshi_info: '当你成为其他角色使用【杀】、【桃】的目标后，你可以令除该角色以外的一-3名其他角色各摸一张牌，然后这些角色也成为此牌的目标。',
              ...
              jlsg_xingchen_info: '分发起始手牌时，你将获得起始手牌改为观看牌堆顶十一张牌并获得其中4张手牌，然后将其余7张牌扣置于武将牌上，称为［星］；摸牌阶段结束时，你可以用一-三张手牌来替换一-二枚［星］',
              jlsg_kuangfeng_info: '回合开始阶段开始时，你可以将一张［星］置入弃牌堆，然后选择一名角色获得一枚［风］标记，若如此做，当其于你的下回合开始前受到火焰伤害时，该伤害+1；雷电伤害时，你令其弃置2张牌；普通伤害时，你摸一张牌置入［星］。',
              ...
              jlsg_wumou_info: '锁定技，当你使用非延时锦囊牌时，你须选择一项：1，弃置一枚［暴］标记；2，受到一点伤害并增加一枚［暴］标记。',
              ...
              jlsg_zhiming_info: '其他角色的回合开始阶段开始时，若其有手牌，你可以弃置一张手牌，然后弃置其一张手牌，若2张牌颜色相同，你令其跳过此回合的摸牌阶段或出牌阶段；若跳过出牌阶段，该角色的回合结束时，将弃置一张牌。',
              jlsg_suyin_info: '你的回合外，当你失去最后的手牌时，可令一名其他角色将其武将牌翻面，然后令其弃置一张牌。',
              jlsg_dianjie_info: '你的回合外，当你使用或打出一张闪后，或你主动跳过出牌阶段后：你可以进行一次判定，若为黑色，可以对一名角色造成一点雷电伤害；若为红色，可以令一-2名未横置的角色进行横置。',
              jlsg_old_dianjie_info: '你可以跳过你的摸牌阶段或出牌阶段，然后判定：若结果为黑色，你对一名角色造成一点雷电伤害；若结果为红色，你令至多两名武将牌未横置的角色将其武将牌横置。',
              jlsg_shendao_info: '锁定技，对一名角色的判定牌生效前，你亮出牌堆顶的2张牌，选择其中一张直接代替之，若不是你的回合，你将另一种牌收入手牌。',
              ...
              jlsg_xianzhu_info: '当一名角色恢复体力后，或失去装备区里的牌后，你可以令其摸2张牌。',
              jlsg_liangyuan_info: '限定技，出牌阶段，你可以选择一名其他男性角色，则于本局游戏中，你的自然回合结束时，该角色进行一个额外的回合。',
              jlsg_tianzi_info: '摸牌阶段开始时，你可以令所有其他角色依次选择一项：1、弃置2张牌；2、令你摸一张牌。',
              ...
              jlsg_jishi_info: '出牌阶段限一次，你可以弃置一张红桃牌选择一名角色，然后触发以下效果：1.若其的手牌大于等于其的体力上限时，先弃置所有手牌再摸等量的牌并展示，其中每有一张非基本牌，你令其恢复一点体力，以此法恢复的过量体力效果改为其摸等量的牌；2.若其的手牌不大于其的体力上限时，令其摸2张牌并展示，其中每有一张非基本牌，你令其恢复一点体力，以此法恢复的过量体力效果改为其摸等量的牌。',
              jlsg_xuanxin_info: '每回合限3次，当一名角色受到伤害后，你可以从弃牌堆获得一张红桃牌，然后可以交给其一张牌。',
              ...
              jlsg_danqing_info: '出牌阶段限一次，你若已受伤可以选择一项：1.令一名其他角色摸X张牌，你将失去一点体力；2.令一名其他角色弃X张牌，你将恢复一点体力（X为你的当前体力）。',
              ...
              jlsg_qimen_一_info: "变化技，锁定技，体力变动时，你随机获得未加入本局游戏的一个常规魏国武将的技能（限定技、变化技、主公技和觉醒技除外〖每局游戏最多发动一次，发动一次之后，你失去此技能获得技能［遁甲］直到游戏结束〗）。",
              jlsg_qimen_info: '变化技，锁定技，游戏开始时/体力变动时，你随机获得未加入本局游戏的一个常规魏国武将的技能（限定技、变化技、主公技和觉醒技除外〖每局游戏最多发动4次，发动4次之后，你失去此技能获得技能［遁甲］直到游戏结束〗）；遁甲：限定技，你的回合开始时，可以选择一名无［禁］的其他角色，该角色获得技能［奇门·改］；奇门·改：将3次数改成1次数，删除游戏开始时。',
              jlsg_xuhuan_info: "锁定技，当你受到伤害/失去体力时，只受到/失去一点伤害/体力，防止多余伤害/体力。",
            },
          };
          if (jilvesanguo.oldCharacterReplace) {
    ...
    config: {
      ...
      oldCharacterReplace: {
        name: '旧版替换',
        intro: '设置是否将本扩展某些武将的技能替换为旧版极略三国的武将技能 旧版不再被维护',
        init: false,
      }
    }, help: {
      ...
      changelog: `\
2021.01.31更新<br>
&ensp; 本次没有更新太多内容：主要是合并了来自民间极略的代码，因此改动较多，可能有较多潜在的bug。<br>
&ensp; 新增了对无名杀武将替换功能的兼容性<br>
