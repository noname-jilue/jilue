...
此阶段结束时受到来自${get.translation(player.storage.jlsg_fushe_source)}的1点伤害'`;
            ...
            jlsg_jinzhi: {
              ...
              enable: 'chooseToUse',
              hiddenCard: function (player, name) {
                if (['basic', 'trick'].contains(get.type(name)) && lib.inpile.contains(name)
                  && player.countCards('h') && !player.getStorage('jlsg_jinzhi2').contains(name) && player.getStorage('jlsg_jinzhi2').length < 4) return true;
              },
              filter: function (event, player) {
                var storage = player.getStorage('jlsg_jinzhi2');
                if (!(player.countCards('h') && storage.length < 4)) return false;
                for (var i of lib.inpile) {
              ...
              chooseButton: {
                dialog: function (event, player) {
                  ...
                  for (var i = 0; i < lib.inpile.length; i++) {
                    ...
                    if (player.getStorage('jlsg_jinzhi2').contains(name)) {
                      continue;
                    }
                    if (name == 'sha') {
                ...
                backup: function (links, player) {
                  return {
                    ...
                    precontent: function () {
                      ...
                      player.markAuto('jlsg_jinzhi2', [event.result.card.name]);
                    },
                  }
                },
                prompt: function (links, player) {
              ...
              ai: {
                ...
                respondSha: true,
                skillTagFilter: function (player, tag, arg) {
                  if (arg && arg.name && player.getStorage('jlsg_jinzhi2').contains(arg.name)) return false;
            ...
            jlsg_jinzhi2: {
              ...
              content: function () {
                var index = player.storage.jlsg_jinzhi2.indexOf(trigger.card.name);
                if (index > 0) {
                  player.draw(index);
                }
              },
            ...
            jlsg_yuyou: {
              ...
              content: function () {
                ...
                player.chooseCard('选择一张牌保留', true,
                  c => _status.event.cards.contains(c),
                  c => get.useful(c, _status.event.player),
                ).set('cards', trigger.cards);
                'step 1'
                event.cards = trigger.cards;
                if (result.bool) {
                  event.cards = event.cards.filter(c => !result.cards.contains(c));
                }
                player.discard(event.cards);
                'step 2'
                ...
                if (!['nei', 'rYe', 'bYe'].contains(player.identity) && event.target.ai.shown > player.ai.shown) {
                  player.addExpose(0.2);
                }
            ...
            jlsg_zhanjue: {
              ...
              filter:function(event,player){
                ...
                if (evt.es&&evt.es.length>0 && !player.countCards('e')) return true;
        ...
        var jlsg_sr = {
          ...
          skill: {
            ...
            jlsg_aozhan2: {
              ...
              content: function () {
                'step 0'
                player.chooseControl('收入手牌', '置入弃牌堆', ui.create.dialog('战', player.getExpansions('jlsg_aozhan'))).ai = function (event, player) {
                  var value = 0, i;
          ...
          skill: {
            ...
            jlsg_zhitian: {
              ...
              content: function () {
                ...
                result.targets[0].addSkillLog(link);
...
新QQ群：392224094<br>
2022.07.24更新<br>
&ensp; 更新武将<div style="display:inline; font-family: xingkai, xinwei;" data-nature="thundermm">SK神甄姬</div><br>
&ensp; 更新武将<div style="display:inline; font-family: xingkai, xinwei;" data-nature="thundermm">SK神甘宁</div><br>
&ensp; 更新武将<div style="display:inline; font-family: xingkai, xinwei;" data-nature="soilmm">SK刘谌</div><br>
&ensp; 优化SK王异 秘计 AI<br>
&ensp; 优化SR陆逊 代劳 AI<br>
&ensp; 优化SK董允 裨补 AI<br>
&ensp; 优化SR刘备 仇袭 AI<br>
&ensp; 优化SR周瑜 筹略 AI<br>
&ensp; 优化SK布骘 折节 AI<br>
&ensp; 优化SR周瑜 伪报 动画<br>
<span style="font-size: large;">历史：</span><br>
2022.07.06更新<br>
&ensp; 更新武将<div style="display:inline; font-family: xingkai, xinwei;" data-nature="watermm">SK曹叡</div><br>
&ensp; 更新武将<div style="display:inline; font-family: xingkai, xinwei;" data-nature="thundermm">SK神张辽</div><br>
&ensp; 优化SK孙乾 随骥 UX<br>
&ensp; 修复SK周妃 姻缘 AI<br>
&ensp; 优化SK潘凤 狂斧 UX<br>
&ensp; 修复SK神张角 神道 配音<br>
&ensp; 修复SK陆抗 衡势 AI<br>
&ensp; 修复SK马良 协穆 优化UX<br>
&ensp; 修复SK潘淑 鱼忧 AI报错<br>
&ensp; 修复SK神吕布潘淑 暴怒<br>
&ensp; 修复多个技能 牌获得来源<br>
&ensp; 重写SK华雄 奋威<br>
&ensp; 重写SR许褚 鏖战<br>
`
      ,
